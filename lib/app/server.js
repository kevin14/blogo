...
module.exports = function(cwd, args, callback) {
    ...
    app.use(cpr(function(router) {
        ...
        router.get('/articles', function(req, res, next) {
            view.render(req,res,next,'ARTICLE_LIST');
        });

        router.get('/tags', function(req, res, next) {
            view.render(req,res,next,'TAG_LIST');
        });

        router.get('/tags/:tagName', function(req, res, next) {
            view.render(req,res,next,'ARTICLE_BY_TAG');
        });
        ...
        router.get('/statics/:resourceName*',function(req,res,next){
